...
class TokenServices:
    ...
    async def create_refresh_token(
        self, user: User, valid_from: datetime
    ) -> RefreshToken:
        # create token
    ...
    async def get_user_from_refresh_token(self, refresh_token: str) -> User:
        user = await self.user_repository.find_by_refresh_token(
    ...
    async def get_user_from_access_token(self, access_token: str) -> User:
        ...
        refresh_token_id = payload.get("sub")
        ...
        user = await self.user_repository.find_by_refresh_token_id(
    ...
    async def revoke_refresh_token(self, refresh_token: str) -> None:
        ...
        try:
            ...
            user = await self.user_repository.find_by_refresh_token(refresh_token)
